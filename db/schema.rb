...
ActiveRecord::Schema.define(version: 20170914111645) do
  ...
  create_table "addresses", force: :cascade do |t|
    ...
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.index ["address_location_type_id"], name: "index_addresses_on_address_location_type_id"
  ...
  create_table "artist_media", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["artist_id"], name: "index_artist_media_on_artist_id"
    t.index ["medium_id"], name: "index_artist_media_on_medium_id"
  end
  ...
  create_table "artist_package_items", force: :cascade do |t|
    ...
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.index ["artist_package_id"], name: "index_artist_package_items_on_artist_package_id"
  end
  ...
  create_table "artist_packages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["artist_id"], name: "index_artist_packages_on_artist_id"
    t.index ["package_id"], name: "index_artist_packages_on_package_id"
  end
  ...
  create_table "artists", force: :cascade do |t|
    ...
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.index ["bank_account_id"], name: "index_artists_on_bank_account_id"
    t.index ["company_id"], name: "index_artists_on_company_id"
    t.index ["member_id"], name: "index_artists_on_member_id"
    t.index ["superannuation_id"], name: "index_artists_on_superannuation_id"
    t.index ["tax_id"], name: "index_artists_on_tax_id"
  end
  ...
  create_table "audio_details", force: :cascade do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["medium_detail_id"], name: "index_audio_details_on_medium_detail_id"
  end
  ...
  create_table "conversions", force: :cascade do |t|
    ...
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.index ["profile_item_type_id"], name: "index_conversions_on_profile_item_type_id"
  end
  ...
  create_table "media", force: :cascade do |t|
    ...
    t.bigint   "duration"
    t.string   "asset"
    t.index ["medium_type_id"], name: "index_media_on_medium_type_id"
  end
  ...
  create_table "medium_details", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["medium_id"], name: "index_medium_details_on_medium_id"
  end
  ...
  create_table "member_addresses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["address_id"], name: "index_member_addresses_on_address_id"
  ...
  create_table "member_contacts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["contact_id"], name: "index_member_contacts_on_contact_id"
    t.index ["member_id"], name: "index_member_contacts_on_member_id"
  end
  ...
  create_table "member_socials", force: :cascade do |t|
    ...
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["member_id"], name: "index_member_socials_on_member_id"
    t.index ["social_type_id"], name: "index_member_socials_on_social_type_id"
  end
  ...
  create_table "members", force: :cascade do |t|
    ...
    t.string   "email"
    t.string   "phone"
    t.index ["account_status_type_id"], name: "index_members_on_account_status_type_id"
    t.index ["member_source_type_id"], name: "index_members_on_member_source_type_id"
  ...
  create_table "profile_artist_types", force: :cascade do |t|
    ...
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["artist_type_id"], name: "index_profile_artist_types_on_artist_type_id"
    t.index ["profile_id"], name: "index_profile_artist_types_on_profile_id"
  end
  ...
  create_table "profile_audios", force: :cascade do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["artist_medium_id"], name: "index_profile_audios_on_artist_medium_id"
    t.index ["profile_id"], name: "index_profile_audios_on_profile_id"
  end
  ...
  create_table "profile_comp_card_items", force: :cascade do |t|
    ...
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
    t.index ["profile_comp_card_id"], name: "index_profile_comp_card_items_on_profile_comp_card_id"
    t.index ["profile_item_type_id"], name: "index_profile_comp_card_items_on_profile_item_type_id"
  end
  ...
  create_table "profile_comp_card_photos", force: :cascade do |t|
    ...
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
    t.index ["profile_comp_card_id"], name: "index_profile_comp_card_photos_on_profile_comp_card_id"
    t.index ["profile_photo_id"], name: "index_profile_comp_card_photos_on_profile_photo_id"
  end
  ...
  create_table "profile_comp_cards", force: :cascade do |t|
    ...
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["profile_id"], name: "index_profile_comp_cards_on_profile_id"
  end
  ...
  create_table "profile_item_values", force: :cascade do |t|
    ...
    t.datetime "created_at",                       null: false
    t.datetime "updated_at",                       null: false
    t.index ["conversion_id"], name: "index_profile_item_values_on_conversion_id"
    t.index ["profile_item_id"], name: "index_profile_item_values_on_profile_item_id"
    t.index ["profile_value_item_type_value_id"], name: "index_profile_item_values_on_profile_value_item_type_value_id"
  end
  ...
  create_table "profile_items", force: :cascade do |t|
    ...
    t.index ["profile_item_type_id"], name: "index_profile_items_on_profile_item_type_id"
  end
  ...
  create_table "profile_photos", force: :cascade do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["artist_medium_id"], name: "index_profile_photos_on_artist_medium_id"
  ...
  create_table "profile_range_item_type_values", force: :cascade do |t|
    ...
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.index ["profile_item_type_id"], name: "index_profile_range_item_type_values_on_profile_item_type_id"
  end
  ...
  create_table "profile_resumes", force: :cascade do |t|
    ...
    t.datetime "updated_at",             null: false
    t.integer  "profile_id"
    t.index ["profile_id"], name: "index_profile_resumes_on_profile_id"
  end
  ...
  create_table "profile_socials", force: :cascade do |t|
    ...
    t.index ["social_type_id"], name: "index_profile_socials_on_social_type_id"
  end
  ...
  create_table "profile_value_item_type_values", force: :cascade do |t|
    ...
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
    t.index ["profile_item_type_id"], name: "index_profile_value_item_type_values_on_profile_item_type_id"
  end
  ...
  create_table "profile_videos", force: :cascade do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.index ["artist_medium_id"], name: "index_profile_videos_on_artist_medium_id"
  ...
  create_table "profiles", force: :cascade do |t|
    ...
    t.index ["artist_id"], name: "index_profiles_on_artist_id"
  end
  ...
  create_table "resume_sections", force: :cascade do |t|
    ...
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.index ["profile_resume_id"], name: "index_resume_sections_on_profile_resume_id"
  end
  ...
  create_table "resume_table_cells", force: :cascade do |t|
    ...
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.index ["resume_section_id"], name: "index_resume_table_cells_on_resume_section_id"
  end
  ...
  create_table "resume_table_media", force: :cascade do |t|
    ...
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.index ["artist_medium_id"], name: "index_resume_table_media_on_artist_medium_id"
    t.index ["resume_section_id"], name: "index_resume_table_media_on_resume_section_id"
  end
